...
def decision(request):
	if request.POST and request.FILES:
		try:
			global filename, id, emailid,pred_decision
			...
			return render (request, 'progress.html', {'graphic' : graphic})
...
def randamforest(request):
 	if request.POST and request.FILES:
 		try:
 			...
 			#return render(request,"progress.html",{'file':a})
 			return HttpResponseRedirect("/progress")
 	...
 	return render(request,'randamforest.html');
